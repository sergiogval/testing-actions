...
1. Commit any change to your branch, such as adding an emoji to your README.md file. :wave:_ If you want to see what happens if an action fails, add an emoji without using shortcode.
